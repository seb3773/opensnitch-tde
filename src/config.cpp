...
const char* Config::KEY_DB_RAM_LIMIT_ENABLE      = "database/ram_limit_enable";
const char* Config::KEY_DB_RAM_LIMIT             = "database/ram_limit";
const char* Config::KEY_DB_RAM_PURGE_INTERVAL    = "database/ram_purge_interval";
